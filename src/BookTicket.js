...
const BookTicket = ({show,handleClose}) => {
  ...
  const [noOFSeats, setNoOFSeats] = useState(localStorage.getItem("seats") || "");
  ...
  function clickHandler(e){
      e.preventDefault();
      setBUttonstate(true);
      setTimeout(()=>{if(name && date && time && email && noOFSeats){
    ...
    <div className="book-ticket-box">
           ...
           <span className="close-icon" onClick={handleClose} >x</span>
            ...
            {!bookingStatus && <div className="poster-img">
        ...
        </div>}
         {
           ...
           message && 
           <div className="message"><p>{message}</p>
